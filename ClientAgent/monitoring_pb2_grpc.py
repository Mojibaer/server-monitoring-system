...
class MonitoringServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.SubmitMetrics = channel.unary_unary(
                ...
                request_serializer=monitoring__pb2.AgentMetrics.SerializeToString,
                response_deserializer=monitoring__pb2.MetricsAck.FromString,
...
def add_MonitoringServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SubmitMetrics': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=monitoring__pb2.AgentMetrics.FromString,
                    response_serializer=monitoring__pb2.MetricsAck.SerializeToString,
            ),
    }
...
class MonitoringService:
    ...
    def SubmitMetrics(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/monitoring.MonitoringService/SubmitMetrics',
            monitoring__pb2.AgentMetrics.SerializeToString,
            monitoring__pb2.MetricsAck.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
